...
def registeropencart(fname, lname, email1, password1):
    ...
    driver.find_element(By.ID, "input-email").send_keys(email1)
    driver.find_element(By.ID, "input-password").send_keys(password1)
